...
const OKONOMIPORTALEN_URL = {
  ...
  development: "https://www.okonomiportalen.dev.intern.nav.no/okonomiportalen",
  production: "https://www.okonomiportalen.intern.nav.no/okonomiportalen",
};

const SOKOS_OKONOMIPORTALEN_PROXY_URL = {
  local: "http://localhost:3000/sokos-okonomiportalen-proxy",
  development: "https://www.okonomiportalen.dev.intern.nav.no/sokos-okonomiportalen-proxy",
  production: "https://www.okonomiportalen.intern.nav.no/sokos-okonomiportalen-proxy",
};

const BASE_URL = {
  local: "http://localhost:3000",
  development: "https://okonomiportalen.dev.intern.nav.no",
  production: "https://www.okonomiportalen.nav.no",
};
